...
*/}}
{{- define "docmost.configMapName" -}}
{{- if .Values.configMap.create }}
{{- default (printf "%s-config" (include "docmost.fullname" .)) .Values.configMap.name }}
{{- else }}
{{- default "docmost-config" .Values.configMap.name }}
{{- end }}
{{- end }}
...
{{- default (printf "%s-secrets" (include "docmost.fullname" .)) .Values.secret.name }}
{{- else }}
